...
{
    [PluginItemInfo(ComponentUniqueId, nameof(PingStatusWatcher),
         "Ping a specific host and reports status changing or watch a specific status", Category = "Web", FriendlyName = "Ping"),
